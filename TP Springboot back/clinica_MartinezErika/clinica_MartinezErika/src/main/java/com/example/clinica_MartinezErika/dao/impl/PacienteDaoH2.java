...
public class PacienteDaoH2 implements IDao<Paciente> {
    ...
    public Paciente guardar(Paciente paciente) {
        ...
        try {
            ...
            Domicilio domicilio = domicilioDaoH2.guardar((Domicilio) paciente.getDomicilio());
           ...
           // preparedStatement.setDate(4, Util.utilDateToSqlDate(paciente.getFechaIngreso()));
            ...
            if(keys.next())
                paciente.setId((Integer) keys.getInt(1));
    ...
    public Paciente buscar(Integer id) {
        ...
        try {
            ...
            while (result.next()) {
                ...
                paciente = new Paciente(idPaciente,nombre,apellido,email,domicilio);
            }
    ...
    public List<Paciente> buscarTodos() {
        ...
        try {
            ...
            while (result.next()) {
                ...
                //Con el domicilio_id traemos el domicilio de la tabla domicilio a traves de DAO de Domicilios
                Domicilio domicilio = domicilioDaoH2.buscar(idDomicilio);
                Paciente paciente = new Paciente(idPaciente,nombre,apellido,email,domicilio);
